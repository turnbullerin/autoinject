...
class TestRegistry(unittest.TestCase):
    ...
    def test_register_class_custom_constructor(self):
        ...
        self.registry.register_class(self.test_class, constructor=build_test)
        obj = self.registry.get_instance(self.test_class)
    ...
    def test_register_class_custom_constructor_args(self):
        ...
        self.registry.register_class(self.test_class, "four", "five", constructor=build_test, z='beta')
        obj = self.registry.get_instance(self.test_class)
        self.assertEqual(obj.def_arg, 'four five')
        self.assertEqual(obj.def_arg2, 'beta')

    def test_cache_strategy_none(self):
        self.registry.register_class(self.test_class, caching_strategy=autoinject.CacheStrategy.NO_CACHE)
    ...
    def test_cache_strategy_global(self):
        self.registry.register_class(self.test_class, caching_strategy=autoinject.CacheStrategy.GLOBAL_CACHE)
    ...
    def test_cache_strategy_context(self):
        self.registry.register_class(self.test_class, caching_strategy=autoinject.CacheStrategy.CONTEXT_CACHE)
